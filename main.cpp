...
vector<string> get_list_dir(const char *path) {
    struct dirent *entry;
...
int main()
{
    ...
    vector<string> data; //list_files;
    data = get_list_dir("tsp_data");
